      ...
      <div className="page-shell">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-6 lg:col-start-7 flex flex-col gap-5">
            <div className="relative min-h-[170px] overflow-hidden bg-[#1C1917] p-6 sm:p-8 lg:p-10" style={{ borderRadius: 3 }}>
              <img
                src={aboutMissionBg}
                alt=""
              ...
              <div
                ...
                style={{ background: "linear-gradient(90deg, rgba(28,25,23,0.85) 0%, rgba(28,25,23,0.5) 30%, rgba(28,25,23,0.15) 85%)" }}
              />
            ...
            <div className="bg-white border border-[#E8E4DE] p-6 sm:p-8 lg:p-10" style={{ borderRadius: 3 }}>
              <div>
